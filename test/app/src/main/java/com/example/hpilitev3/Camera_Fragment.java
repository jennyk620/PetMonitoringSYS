...
import com.example.hpilitev3.databinding.FragmentVideoBinding;
...
public class Camera_Fragment extends Fragment implements View.OnClickListener {
    private static final String TAG = "VideoFragment";    //Superbrain 대신 원하는 폴더이름을 만들면 됩니다.
    private static final String DETAIL_PATH = "DCIM/Superbrain/";
    FragmentVideoBinding binding;    // 카메라 광각, 전면, 후면
    ...
    private void openCamera(int width, int height) {
        ...
        try {
            ...
            //Log.e("VIDEO SIZE",mVideoSize.getWidth() + " " + mVideoSize.getHeight() );
...
//        Disposable disposable = duration.subscribeOn(Schedulers.io()).observeOn(AndroidSchedulers.mainThread()).subscribe(timeout -> {
//            long min = timeout / 60;
//            long sec = timeout % 60;
//            String sMin;
//            String sSec;
...
//    }
    ...
    CompositeDisposable mCompositeDisposable; // 여기까지는 타이머 부분이기 때문에 사용안하셔도 됩니다.
